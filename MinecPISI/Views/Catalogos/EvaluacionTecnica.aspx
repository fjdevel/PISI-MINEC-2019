<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Layouts/Layout2.Master" AutoEventWireup="true" CodeBehind="EvaluacionTecnica.aspx.cs" Inherits="MinecPISI.Views.Catalogos.EvaluacionTecnica" %>
...
<div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="  font-weight-bold text-primary">Administracion de Evaluacion Tecnica</h6>
            ...
            <a href="#"
                ...
                data-m="pos"
                data-title="Crear Criterio Evaluacion"
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTableDepartamentos" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>Criterio evaluacion tecnica SUP</th>
                            <th>Criterio</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=item.TIPO_EVAL %></td>
                            <!--BOTON MODIFIFCAR -->
                            <td class="text-center">
                                <a href="#" class="btn btn-info btn-circle"
                                    data-toggle="modal"
                                    data-target="#DataCEvaluacionModal"
                                    data-id-evaluacion-tecnica="<%= item.ID_CRITERIO_EVAL_TECNICO %>"
                                    data-id-criterio-tecnica-sup="<%= criterio.ID_CRITERIO_EVAL_TECNICO %>"
                                    data-criterio-evaluacion-tecnica="<%= item.CRITERIO %>"
                                    data-tipo-evaluacion-tecnica="<%=item.TIPO_EVAL %>"
                                    data-m="put"
                                    data-title="Editar Criterio Evaluacion">
                            ...
                            <td class="text-center">
                                <a href="#"
                                   ...
                                   data-id-evaluacion-tecnica="<%= item.ID_CRITERIO_EVAL_TECNICO %>"
                                    data-title="Eliminar Criterio Evaluacion">
            ...
            <div class="modal-content">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="txt_id_criterio_tecnica_sup" value="" />
                        ...
                        <div class="form-group">
                            <label>Campo</label>
                            <input type="text" class="form-control" name="txt_criterio_evaluacion_tecnica" placeholder="Ingrese Campo" required>
                        </div>
                        
                        <div class="form-group">
                            <label>Puntaje Maximo</label>
                            <input type="text" class="form-control" name="txt_tipo_evaluacion_tecnica" placeholder="Ingrese puntaje maximo" required>
                        </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="jsextra" runat="server">
    ...
    <script>
        $("#DataCEvaluacionModal").on("show.bs.modal", function (event) {
            ...
            var id_criterio_tecnica_sup = button.data('id-criterio-tecnica-sup');
            var criterio_evaluacion_tecnica = button.data('criterio-evaluacion-tecnica');
            var tipo_evaluacion_tecnica = button.data('tipo-evaluacion-tecnica');
            var m = button.data('m');
            var title = button.data('title');

            $('input[name=txt_id_evaluacion_tecnica]').val(id_evaluacion_tecnica);
            $('input[name=txt_id_criterio_tecnica_sup]').val(id_criterio_tecnica_sup);
            $('input[name=txt_criterio_evaluacion_tecnica]').val(criterio_evaluacion_tecnica);
            $('input[name=txt_tipo_evaluacion_tecnica]').val(tipo_evaluacion_tecnica);
            $('input[name=m]').val(m);

            //Borrando la seleccion anterior
            $('select[name=select_id_criterio_tecnica] option').removeAttr("selected");
            $('select[name=select_id_criterio_tecnica] option[value=' + id_criterio_tecnica_sup + ']').attr('selected', 'selected');   //Configurando el departamento del usuario
