                            ...
                            <div class="col-lg-12">
                                ...
                                <form id="form1" runat="server">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            ...
                                            <div id="tercero02">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <asp:Label ID="lbl_escritura" runat="server" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <asp:Label ID="lbl_estadoie" runat="server" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    ErrorMessage="debes subir un archivo" ForeColor="red" ControlToValidate="fl_cuerpo" />--%>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <asp:Label ID="lbl_constancia" runat="server" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <asp:Label ID="lbl_estadore" runat="server" />
                                                    </div>
                                                </div>
                                        ...
                                        <Triggers>
                                            <asp:PostBackTrigger ControlID="btn_anterior" />
                                            <asp:PostBackTrigger ControlID="btn_finalizar" />
                                            <asp:PostBackTrigger ControlID="btn_upload_escritura" />
                                            <asp:PostBackTrigger ControlID="btn_upload_estadoie" />
                                            <asp:PostBackTrigger ControlID="btn_upload_cuerpo" />
                                            <asp:PostBackTrigger ControlID="btn_constancia" />
                                            <asp:PostBackTrigger ControlID="btn_estadore" />
                                        </Triggers>
                                    </asp:UpdatePanel>
