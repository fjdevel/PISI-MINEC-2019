      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-header p-0">
                <h4 class="h3 text-center"> Proyecto Especial de Pequeñas Inversiones para Soluciones Innovadoras</h4>
            </div>
          <div class="card-body p-0">
            <!-- Nested Row within Card Body -->
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block ">
                <img src="<%= ResolveUrl("~/Views/img/corredor-productivo.jpg") %>" width="500">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h3 text-gray-900 mb-4">Inicio de sesión</h1>
                  ...
                  <div class="text-center">
                    <a class="small" href="<%Response.Write(HttpContext.Current.Request.ApplicationPath);%>/Beneficiario/RegistroAyuda">Registrarse como beneficiario</a>
                    <a class="small" href="<%Response.Write(HttpContext.Current.Request.ApplicationPath);%>/Formulacion/Registro">Registrarse como formulador</a>
                  </div>
                </div>
              </div>
            </div>
