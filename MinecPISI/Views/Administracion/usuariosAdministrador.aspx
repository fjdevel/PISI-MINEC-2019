                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" class="btn btn-info btn-circle" data-toggle="modal" data-target="#DataUserModal"
                                    ...
                                    data-id-departamento="<%= new BLL.Acciones.A_MUNICIPIO().obtenerDepartamentoByIdMunicipio((int)p.ID_MUNICIPIO).ID_DEPARTAMENTO %>"
            ...
            <form action="" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="txt_telefono_fijo" placeholder="Ingrese el número de teléfono sin guiones" required>
                    </div>

                    <div class="form-group">
                         <label>Teléfono Celular</label>
                        <input type="tel" class="form-control" name="txt_telefono_cel" placeholder="Ingrese el número de celular sin guiones" required>
                    </div>
