    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <% foreach (var notificacion in notificaciones) {%>
                <div class="dropdown-item d-flex align-items-center" id="<%=notificacion.ID_NOTIFICACION %>">
                    <% if (!notificacion.LEIDO) { %><i class="fas fa-circle fa-xs" style="color:#0054A6"></i> <% } %>
                    <div class="mr-3">
                        <div class="icon-circle <%=notificacion.TIPO.COLOR %>">
                            <i class="<%=notificacion.TIPO.ICONO %>"></i>
                        </div>
                    </div>
                    <div>
                        <div class="small text-gray-500"><%=notificacion.FECHA_CREA %></div>
                        <span><%=notificacion.TIPO.TITULO %></span> <br />
                        <span class="text-secondary"><%=notificacion.DESCRIPCION %></span>
                    </div>
                </div>
            <% } %>
...
<%--             <!-- Notificaciones del Beneficiario------------------------------------------------------------------------>
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
                ...
                <div>
                    ...
                    <span>Debes ingresar documentación adicional para Precalificarte</span> <br />
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
             ...
             <!--Notifica que Se ha asignado nuevo beneficiario -->
            <a class="dropdown-item d-flex align-items-center" href="#">
                <div class="mr-3">
                    <div class="icon-circle bg-info">
                ...
                <div>
                    <div class="small text-gray-500">02 Septiembre de 2019</div>
                    Se ha asignado un nuevo Beneficiario a tu cartera  <span class=" font-weight-bold">Ver</span>!
                </div>
            </a>
            ...
            <!--Notifica que Se ha asignado un nuevo caso -->
            <a class="dropdown-item d-flex align-items-center" href="#">
                <div class="mr-3">
                    <div class="icon-circle bg-info">
                        <i class="fa fa-file text-white"></i>
                ...
                <div>
                    <div class="small text-gray-500">02 Septiembre de 2019</div>
                    Se ha asignado un nuevo Caso a tu cartera, plantea una <span class=" font-weight-bold">Propuesta de Solución</span>!
                </div>
            </a>
