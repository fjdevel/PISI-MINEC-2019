...
{
    public partial class EvaluarIniciativa : System.Web.UI.Page
    {
        ...
        protected void GVEvaluacionComite_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            int RowSpan = 2;
            for (int i = GVEvaluacionComite.Rows.Count - 2; i >= 0; i--)
            {
                GridViewRow currRow = GVEvaluacionComite.Rows[i];
                GridViewRow prevRow = GVEvaluacionComite.Rows[i + 1];
