<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Layouts/Layout2.Master" AutoEventWireup="true" CodeBehind="DetalleIniciativaInnovacion.aspx.cs" Inherits="MinecPISI.Views.Formulacion.DetalleIniciativaInnovacion" %>
        ...
        <div class="card-body">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="nav-matriz-tab" data-toggle="tab" href="#nav-matriz" role="tab" aria-controls="nav-matriz" aria-selected="false">Iniciativa de Proyecto de Innovación y o desarrollo Tecnológico</a>
              </div>
            </nav>
...
<asp:Content ID="Content4" ContentPlaceHolderID="jsextra" runat="server">
    ...
    <script>
        ...
        $(() => {
         ...
         $('#montoTotalContrapartida').val(psum * 0.10);
          $('#montoCofinanciado').val(psum *.90);
          $('#montoProyecto').val(psum);
             var headers = [
