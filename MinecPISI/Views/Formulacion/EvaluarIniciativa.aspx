...
<asp:Content ID="Content3" ContentPlaceHolderID="bodyContentBlank" runat="server">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="font-weight-bold text-primary">Evaluación de la iniciativa</h5>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                    <asp:GridView
                        ID="GVEvaluacionComite"
                        runat="server"
                        AutoGenerateColumns="False"
                        DataKeyNames="IdCampo"
                        CssClass="table table-bordered"
                        OnRowDataBound="GVEvaluacionComite_RowDataBound"
                        ShowFooter="true">
                        <Columns>
        ...
        <div id="Botones" runat="server" class="text-center mt-4 mb-4">
            ...
            <!--<asp:LinkButton id="BtnAprobar" runat="server" cssClass="btn btn-success btn-icon-split mb-1" type="submit" disabled="disabled" UseSubmitBehavior="True" OnClick="AprobarClick">
