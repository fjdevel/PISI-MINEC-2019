...
<asp:Content ID="Content4" ContentPlaceHolderID="bodyContentBlank" runat="server">
 <div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <a href="#" data-toggle="modal" data-target="#DataRoleModal" data-m="pos" data-title="Crear Rol" class=" btn btn-sm btn-primary shadow-sm "><i class="fas fa-plus fa-sm text-white-50"></i> Agregar nuevo Rol</a>
                    ...
                    <% foreach (BLL.Modelos.TB_ROL r in data) { %>
                       <tr>
                            ...
                            <td class="text-center">
                                <a href="#" class="btn btn-info btn-circle" data-toggle="modal" data-target="#DataRoleModal"
                                    data-pk="<%=r.ID_ROL %>"
...
<div class="modal fade show" id="DataRoleModal" tabindex="-1" role="dialog" aria-modal="true" style="padding-right: 17px; display: none;">
