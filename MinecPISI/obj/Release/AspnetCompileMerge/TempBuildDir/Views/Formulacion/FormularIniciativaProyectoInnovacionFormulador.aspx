        ...
        <div class="card-body">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="nav-matriz-tab" data-toggle="tab" href="#nav-matriz" role="tab" aria-controls="nav-matriz" aria-selected="false">Asistencia Técnica y/o transferencia de conocimiento descrita
</a>
              </div>
            </nav>
            <form class="tab-content" id="nav-tabContent" method="post">
                  ...
                  <div class="tab-pane fade" id="nav-plant" role="tabpanel" aria-labelledby="nav-tab-1">
                      <div class="form-group mt-2">
                          ...
                          <textarea class="form-control" required="required"  name="producto" id="producto" rows="4"></textarea>
                      </div>
                      <div class="form-group mt-2">
                          <label>Proceso</label>
                          <textarea class="form-control" required="required"  name="proceso" id="proceso" rows="4"></textarea>
                      </div>
                      <div class="form-group mt-2">
                          <label>Modelo de comercialización</label>
                          <textarea class="form-control" required="required"  name="modelo" id="modelo" rows="4"></textarea>
                      </div>
                      <div class="form-group mt-2">
                          <label>¿Los insumos para el desarrollo se encuentra disponible localmente?</label>
                          <div class="radio">
                            <label><input type="radio" name="optlocal" id="localsi" checked class="radio-opt">Si</label>
                        </div>
                        <div class="form-group mt-2">
                          <label>Describa genericamente los insumos necesarios</label>
                          <textarea class="form-control" required="required"  name="insumosnecesarios" id="insumosnecesarios" rows="4"></textarea>
                      </div>
                          <div class="radio">
                            <label><input type="radio" name="optlocal" id="localno" class="radio-opt">No</label>
                        </div>
                      </div>
                      <div class="form-group mt-2">
                      ...
                      <div class="form-group mt-2">
                          ...
                          <textarea class="form-control" required="required"  name="insumosdescripcion" id="insumosdescripcion" rows="4"></textarea>
                      </div>
                  ...
                  <div class="tab-pane fade" id="nav-contrapartida" role="tabpanel" aria-labelledby="nav-contrapartida-tab">
                     <div class="form-group mt-2">
                      ...
                      <div class="form-group mt-2">
                          <div class="row">
                              <label class="col-md-6">Montos de Iniciativa de Proyecto de Innovación y o desarrollo Tecnológico</label>
                      ...
                      <div class="form-group mt-2">
                          <div class="row">
                              <label class="col-md-6">Recursos Adicionales  para la Iniciativa de Proyecto de Innovación y o desarrollo Tecnológico</label>
